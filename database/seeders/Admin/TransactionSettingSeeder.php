...
class TransactionSettingSeeder extends Seeder
{
    ...
    public function run()
    {
        $transaction_settings = array(
            ...
            array('id' => '13','admin_id' => '1','slug' => 'money_exchange','title' => 'Money Exchange Charges','fixed_charge' => '1.00','percent_charge' => '1.00','min_limit' => '1.00','max_limit' => '10000.00','monthly_limit' => '0.00','daily_limit' => '0.00','status' => '1','created_at' => now(),'updated_at' => now(),'agent_fixed_commissions' => '0.00','agent_percent_commissions' => '0.00','agent_profit' => true),
        );
        ...
        try{
            ...
            foreach($transaction_charges as $charge){
                $charge->daily_limit  = 1000;
                $charge->monthly_limit  = 5000;
                $charge->save();
            }
        }catch(Exception $e){}
    }
