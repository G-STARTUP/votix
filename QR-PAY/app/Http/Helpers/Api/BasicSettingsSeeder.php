...
class BasicSettingsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Use create() because firstOrCreate builds a WHERE clause using all
        // supplied attributes — that can fail if some columns don't yet exist
        // during migrations. Truncate ensures table is empty, so create() is safe.
        BasicSettings::create($data);
    }
}
