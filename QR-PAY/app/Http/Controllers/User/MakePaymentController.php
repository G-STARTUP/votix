...
class MakePaymentController extends Controller
{
    ...
    public function confirmed(Request $request){
        ...
        if( $sender_wallet->user->email == $validated['email']) return back()->with(['error' => [__("Can't payment to your own")]]);
        ...
        $receiver = Merchant::where('email',$validated['email'])->active()->first();
