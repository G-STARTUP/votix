...
class MobileTopupController extends Controller
{
    ...
    public function topupCharge($sender_amount,$charges,$sender_wallet) {
        ...
        $data['agent_percent_commission']           = get_amount(($sender_amount / 100) * $charges->agent_percent_commissions,null,$sPrecision) ?? 0;
    ...
    public function payAutomatic(Request $request){
        ...
        //topup api
         $topUpData = [
            ...
            'amount'            => getAmount($charges['payable_to_provider'],get_wallet_precision()),
