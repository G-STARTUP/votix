...
class SendMoneyController extends Controller
{
    ...
    public function confirmed(Request $request){
        ...
        if( $sender_wallet->user->email == $validated['email']) return back()->with(['error' => [__("Can't send money to your own")]]);
        ...
        $receiver = User::notAuth()->where('email',$validated['email'])->active()->first();
